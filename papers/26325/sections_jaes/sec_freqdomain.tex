...
listening-area reference (basis B2--B5, \cref{sec:room}), and let the role be
...
the margin of the combined ceiling \cref{eq:master} over the listening-area
...
\begin{figure}[htbp]
	...
	complete band, on one listening-area reference basis. Top: margin of the
